...
# 1. Import Zip File
library(readxl)
AirQuality <-read_excel(unzip("E:/munmun_acadgild/acadgild data analytics/supporting files/AirQualityUCI.zip"))
#AirQuality <- read_excel("E:/munmun_acadgild/acadgild data analytics/supporting files/AirQualityUCI.xlsx")
View(AirQuality)
Air <- AirQuality
dim(Air)
str(Air)
